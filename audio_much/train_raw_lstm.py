...
def build_lstm_audio_network(n_classes):
    ...
    lstm = LSTM(32, dropout=0.15, recurrent_dropout=0.35, return_sequences=True)(inputs)
    lstm = LSTM(32, dropout=0.15, recurrent_dropout=0.35, return_sequences=True)(lstm)
    lstm = LSTM(32, dropout=0.15, recurrent_dropout=0.35, return_sequences=True)(lstm)
    lstm = LSTM(32, dropout=0.15, recurrent_dropout=0.35, return_sequences=False)(lstm)
